...
var (
	...
	pattern_Query_Pool_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"mychain", "pool", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PoolAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1}, []string{"mychain", "pool"}, "", runtime.AssumeColonVerbOpt(true)))
)
