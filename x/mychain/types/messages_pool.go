...
func NewMsgCreatePool(creator string, denom string, desc string, height int32) *MsgCreatePool {
...
func NewMsgUpdatePool(creator string, id uint64, denom string, desc string, height int32) *MsgUpdatePool {
